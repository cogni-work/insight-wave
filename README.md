...
| [cogni-publishing](cogni-publishing/README.md) | Publishing Contracts | 4 | 0 | Versioned brief normalization, provenance-preserving artifact validation, explicit renderer boundaries, and the theme lifecycle |
...
**92 skills, 65 agents** across the 9 active plugins.
