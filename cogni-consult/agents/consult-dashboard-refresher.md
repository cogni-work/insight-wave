...
- **If it does not exist**: search for the most recently modified `theme.md` in the workspace via Glob (`**/cogni-publishing/**/themes/**/*.md`). If found, use the `--theme` flag in step 2.
