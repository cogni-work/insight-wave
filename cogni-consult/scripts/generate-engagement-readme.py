...
# Footer sentinel identifying a script-generated README. The overwrite guard in
# main() keys on it: a root README.md without this marker is hand-authored and
# is never overwritten.
GENERATED_MARKER = (
    "_Auto-generated front door — regenerated at engagement milestones; "
...
def main():
    ...
    try:
        ...
        # Never clobber a hand-authored front door: an existing README.md
        # without the generated-marker footer was written by a person, not by
        # this script — refuse and let the caller surface the warning.
        if os.path.exists(readme_path):
            ...
            if GENERATED_MARKER not in existing:
                print(json.dumps({
                    ...
                    "error": "existing README.md was not generated by this script (marker absent); refusing to overwrite a hand-authored front door",
                }))
                return 1
