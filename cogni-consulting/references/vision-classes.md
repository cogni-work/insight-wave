---
name: vision-classes
description: Maps each vision class to recommended methods per phase and typical engagement characteristics.
---

# Vision Classes

Each vision class represents a type of consulting engagement outcome. The class determines which methods are recommended in each phase and what deliverables are produced.

## strategic-options

**Outcome**: Ranked strategic alternatives with evaluation criteria.
**Typical duration**: 4-8 weeks | **Decision type**: Portfolio/investment choice
...
**Outcome**: Investment justification with financials and risk analysis.
**Typical duration**: 3-6 weeks | **Decision type**: Go/no-go investment
...
**Outcome**: Go-to-market plan with channels, segments, and timeline.
**Typical duration**: 4-6 weeks | **Decision type**: Launch strategy
...
**Outcome**: Prioritized cost reduction opportunities with implementation plan.
**Typical duration**: 3-5 weeks | **Decision type**: Savings allocation
...
**Outcome**: Current-to-target state mapping with transition roadmap.
**Typical duration**: 6-12 weeks | **Decision type**: Transformation program
...
**Outcome**: Prioritized innovation investment bets across horizons.
**Typical duration**: 4-8 weeks | **Decision type**: R&D/innovation allocation
...
**Outcome**: Market feasibility assessment and entry strategy.
**Typical duration**: 4-8 weeks | **Decision type**: Enter/defer/partner
