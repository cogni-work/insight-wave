...
|-----|---|----------------|----------------|----|----|----|----|----|
| corporate-visions | 1 | Why Change: Unconsidered Needs | Warum Wandel: Unerkannte Handlungsbedarfe | Pourquoi changer : besoins insoupçonnés | Perché cambiare: bisogni inespressi | Dlaczego zmiana: nieuświadomione potrzeby | Waarom veranderen: onopgemerkte behoeften | Por qué cambiar: necesidades no consideradas |
...
| corporate-visions | 3 | Why You: Unique Positioning | Warum Sie: Einzigartige Positionierung | Pourquoi vous : positionnement unique | Perché voi: posizionamento unico | Dlaczego Państwo: wyjątkowe pozycjonowanie | Waarom u: unieke positionering | Por qué usted: posicionamiento único |
