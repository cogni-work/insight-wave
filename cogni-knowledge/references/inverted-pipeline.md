...
| 4.5 | `knowledge-distill` (optional, fail-soft) | `ingest-manifest.json` + `wiki/sources/*.md` claims + existing distilled pages | `wiki/{concepts,entities,summaries,learnings}/<slug>.md` (with `distilled_claims:`; summary/learning added at #342), updated `wiki/index.md`, `wiki/log.md`, `<project>/.metadata/distill-manifest.json` |
