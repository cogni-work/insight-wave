...
| 7 | `knowledge-finalize` | verified draft | `wiki/syntheses/<slug>.md` (cycle-guarded), updated binding, `<project>/.metadata/contradictor-vN.json` (when `high > 0` or `unknown > 0`, #335) |
