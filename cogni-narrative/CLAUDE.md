...
- **Upstream**: Research syntheses from cogni-knowledge (inverted-pipeline output; legacy cogni-research output directories still parse via the same `.metadata/` arc probe); TIPS dimension data from cogni-trends
