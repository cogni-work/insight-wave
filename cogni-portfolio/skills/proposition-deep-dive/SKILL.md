...
- MEANS change (before/after)
- Evidence added
- Downstream impact (competitors, solutions affected)
- Cross-pollination notes for sibling propositions
- Any upstream signals (feature description limitations)
