...
consumers:
  - ${CLAUDE_PLUGIN_ROOT}/references/arc-registry.md (a new arc adds a mapping row and an element block here)
...
IF arc_id is set:
  READ $CLAUDE_PLUGIN_ROOT/references/arc-taxonomy.md
