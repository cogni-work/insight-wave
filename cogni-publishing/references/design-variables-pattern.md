...
1. **Select a theme** — User selects a theme via `cogni-publishing:manage-themes` Operation 11 (Select Theme). Returns `theme_path`, `theme_name`, `theme_slug`.
...
- **Theme entry point**: `cogni-publishing:manage-themes` skill, Operation 11 (Select Theme)
- **Saved-theme contract**: `references/theme-artifact-contract.md` — the selection handoff, the tiers and the generated token projections a consumer reads
