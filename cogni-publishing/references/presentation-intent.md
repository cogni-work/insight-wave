...
`${CLAUDE_PLUGIN_ROOT}/references/design-brief-template.md` defines the
...
`${CLAUDE_PLUGIN_ROOT}/references/design-brief-template.md`. One divergence
...
closes on a `sources` unit (`${CLAUDE_PLUGIN_ROOT}/references/design-brief-template.md`),
