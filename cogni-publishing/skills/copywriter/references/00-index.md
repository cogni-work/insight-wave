...
LOAD: ${CLAUDE_PLUGIN_ROOT}/references/arc-{arc_id}.md
LOAD: ${CLAUDE_PLUGIN_ROOT}/references/techniques-overview.md
...
### Outside this tree
- `${CLAUDE_PLUGIN_ROOT}/references/techniques-overview.md` -- the ecosystem's single copy of the impact techniques: Number Plays (6), Forcing Functions, Contrast Structure, You-Phrasing, Compound Impact Calculation, plus the per-arc-element application matrix. Loaded by the Arc and Sales blocks and by Step 5.
