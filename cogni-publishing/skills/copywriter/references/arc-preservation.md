...
related:
  - narrative arc contracts (${CLAUDE_PLUGIN_ROOT}/references/arc-{arc}.md)
version: 2.2
...
- Arc contracts (headings, elements, validation): `${CLAUDE_PLUGIN_ROOT}/references/arc-{arc}.md`
- Narrative techniques: `${CLAUDE_PLUGIN_ROOT}/references/techniques-overview.md`
- Story arc contracts: `${CLAUDE_PLUGIN_ROOT}/references/arc-*.md` — the arcs this mode polishes, bundled flat in the sibling text-to-narrative skill
