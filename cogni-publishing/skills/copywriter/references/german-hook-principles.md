---
title: German Hook Principles (Wolf Schneider / Ludwig Reiners / Henri Nannen)
type: writing-principle
category: core-principles
tags: [german, hook, opening-sentence, wolf-schneider, ludwig-reiners, henri-nannen, erster-satz]
audience: [all]
related:
...
### Regel 1: Der erste Satz existiert nur, damit der zweite gelesen wird

The first sentence has exactly one job: make the reader continue. It does not summarize, introduce context, or establish credentials. It hooks.

**Vorher:** "In der folgenden Analyse untersuchen wir die Auswirkungen der Digitalisierung auf den deutschen Mittelstand."
**Nachher:** "Der deutsche Mittelstand digitalisiert sich -- aber in die falsche Richtung."

Why: The original announces an analysis. The revision creates tension that demands continuation.
...
- The **single most important conclusion** of the entire document
...
### Regel 3: Nie mit einer Binsenweisheit beginnen

Never open with a self-evident statement, a truism, or something the reader already knows. If your reader would respond "Ja, und?" -- the sentence fails.
...
- "Siemens suchte 18 Monate einen einzigen KI-Ingenieur in Erlangen."
- "Jeder dritte Maschinenbauer produziert mit Software von 2015."
...
### Regel 5: Konkret, nicht abstrakt

Name people, places, things. The reader's brain activates with concrete images, not abstract categories.
...
### Regel 6: Mit einem Erdbeben anfangen
...
### Regel 7: Wenn der 7. Satz besser ist, streiche alles davor

Wolf Schneider's most quoted rule. Read your opening paragraph. Find the strongest sentence. If it is not the first one -- make it the first one. Everything before it was throat-clearing.

**Anwendung:**
1. Read the first paragraph completely
2. Identify the sentence with the highest surprise or impact
3. Move it to position 1
...
2. Imagine shouting it to someone in the next room
3. If it works ("Die haben alles richtig gemacht und stecken trotzdem in der Krise!") -- pass
4. If it requires explanation ("Also, 98 Prozent sind KMU, und...") -- fail

**Pass examples:**
- "Trumpf baut Mitarbeiter ab -- zum ersten Mal in 100 Jahren!"
- "Jeder dritte Maschinenbauer sucht vergeblich Nachfolger!"
- "Der Mittelstand digitalisiert sich in die falsche Richtung!"

**Fail examples:**
- "98 Prozent der Unternehmen im deutschen Maschinensektor sind KMU." (So what?)
- "Die aktuelle Situation im Maschinenbau ist komplex." (Says nothing)
- "Im Rahmen der Transformation stellen sich Herausforderungen." (Floskel)

---

### Regel 9: Zahlen transformieren, nicht voranstellen

Never lead with a raw statistic. Numbers are powerful but they need framing to create impact. Transform numbers into vivid, surprising statements. The number itself becomes sentence 2 or 3 as the evidence anchor.

**Roh (vermeiden):** "98 Prozent der Unternehmen im deutschen Maschinensektor sind KMU."
**Transformiert (verwenden):** "Der deutsche Maschinenbau-Mittelstand hat alles richtig gemacht -- und steckt genau deshalb im tiefsten Strukturwandel seit Jahrzehnten."

The raw number (98%) then follows as the evidence that grounds the claim.

**Roh:** "68 Prozent der Betriebe haben Schwierigkeiten bei der Nachfolge."
**Transformiert:** "Zwei von drei Maschinenbauern finden keinen Nachfolger." (Ratio framing makes the number vivid while keeping it in the opening.)

**Ausnahme:** A number MAY open the sentence if it is itself the surprise:
- "Null. So viele KI-Experten hat der durchschnittliche deutsche Maschinenbauer."
- "1.247 Tage dauert eine Baugenehmigung in Berlin im Schnitt."

---

### Regel 10: Den Leser umwerben

Schneider's principle of editorial investment: invest maximum craft in the first sentence. Rewrite it 5, 10, 20 times if necessary. The first sentence carries disproportionate return on polish.

**Practical method:**
1. Write the entire text first
2. Return to the first sentence last
3. Write 5 alternative openings
4. Test each against Rules 1-9
5. Choose the one that passes the most tests
6. If none passes all tests, combine elements and try again
...
## Applying Hook Rules to Arc Documents

When polishing arc documents (corporate-visions, industry-transformation, etc.), the hook is the opening paragraph(s) before the first H2 arc element. Apply these 12 rules specifically to the hook's first 1-2 sentences.

### Decision Tree for Arc Hook Polish

```
1. Read the hook's first sentence
2. Test against Rules 2, 3, 4, 8, 9 (the five critical tests)
3. Count failures:
   - 0 failures: Hook passes. Strengthen language only (Power Words, rhythm)
   - 1-2 failures: Marginal. Attempt revision within current structure
   - 3+ failures: Hook fails. Restructure opening 1-2 sentences

When restructuring:
- Apply Regel 7: Find the strongest sentence in the hook, promote it
- Apply Regel 2: Lead with surprise or main conclusion
- Apply Regel 9: Move raw statistics to sentence 2-3 as evidence anchor
- Preserve ALL citations, facts, and data
- Preserve the hook's overall purpose and message
- Only restructure the first 1-2 sentences; the rest is structure-protected
```

### Arc-Specific Hook Strategies
...
## Quality Checklist for Opening Sentences

Use this checklist to validate every opening sentence you write or polish.
...
- `${CLAUDE_PLUGIN_ROOT}/references/arc-{arc}.md` (each arc's `## Composition` — what its opening emphasizes)
