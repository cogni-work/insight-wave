...
Fixture 1 reuses the canonical DE source from `cogni-publishing/tests/fixtures/copywriter/test-docs/`
...
```bash
bash cogni-publishing/tests/fixtures/copywriter/readability-rule/run.sh
```
