...
SCRIPT="$REPO_ROOT/cogni-publishing/skills/copywriter/scripts/calculate_readability.py"
SOFT_FLOOR=5

DE_SOURCE="$REPO_ROOT/cogni-publishing/tests/fixtures/copywriter/test-docs/german-with-citations.md"
