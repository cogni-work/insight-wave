...
ENTITY_DIRS = {
    ...
    'concepts': '05-domain-concepts',  # unified: domain-concepts is the standard location
...
README_DIRS = {
    ...
    'concepts': ('05-domain-concepts', False),
    'megatrends': ('06-megatrends', False),
    'sources': ('07-sources', False),
    'publishers': ('08-publishers', False),
    'citations': ('09-citations', False),
    'claims': ('10-claims', False),
    'trends': ('11-trends', True),  # Has README-{dim}.md files
    'synthesis': ('12-synthesis', False),
}
...
UI_TRANSLATIONS = {
    'en': {
        ...
        'tab_sources': 'Sources',
        # Overview cards
        'card_syntheses': 'Dimensions',
        'card_syntheses_desc': 'Deep analysis organized by research dimension',
        'card_megatrends': 'Megatrends',
        'card_megatrends_desc': 'Cross-dimensional forces shaping the landscape',
        'card_trends': 'Trends',
        'card_trends_desc': 'Evidence-based patterns across planning horizons',
        'card_findings': 'Findings',
        'card_findings_desc': 'Research evidence in the panel',
        'card_claims': 'Claims',
        'card_claims_desc': 'Verified assertions',
        'card_concepts': 'Concepts',
        'card_concepts_desc': 'Domain knowledge clusters',
        # Right panel detail tabs
        'detail_findings': 'Findings',
        'detail_claims': 'Claims',
        'detail_sources': 'Sources',
        'detail_citations': 'Citations',
        'detail_concepts': 'Concepts',
        'detail_questions': 'Questions',
        'detail_methodology': 'Methodology',
        # Graph controls
        'graph_all_types': 'All Types',
        'graph_synthesis': 'Synthesis',
        'graph_megatrend': 'Megatrend',
        'graph_trend': 'Trend',
        'graph_concept': 'Concept',
        'graph_claim': 'Claim',
        'graph_finding': 'Finding',
        'graph_source': 'Source',
        'graph_citation': 'Citation',
        ...
        'type_trend': 'Trends',
        'type_synthesis': 'Dimension Syntheses',
        'type_finding': 'Findings',
        'type_claim': 'Claims',
        'type_source': 'Sources',
        'type_concept': 'Concepts',
        'type_megatrend': 'Megatrends',
        'type_citation': 'Citations',
        ...
        'nav_title_synthesis': 'Dimensions',
        'nav_title_megatrends': 'Megatrends',
        'nav_title_trends': 'Trends',
        'aria_section_nav': 'Section navigation',
        # Kanban corner
        'kanban_corner': 'Dimensions',
        # TOC labels
        ...
        'js_type_trend': 'Trend',
        'js_type_synthesis': 'Dimension Synthesis',
        'js_type_finding': 'Finding',
        'js_type_claim': 'Claim',
        'js_type_source': 'Source',
        'js_type_concept': 'Concept',
        'js_type_megatrend': 'Megatrend',
        'js_type_citation': 'Citation',
        'js_type_dimension': 'Dimension',
        'js_type_question': 'Question',
        'js_loading_entities': 'Loading {0} entities\u2026',
        'js_portfolio': 'portfolio',
        'js_portfolios': 'portfolios',
    },
    'de': {
        'html_lang': 'de',
        ...
        'tab_claims': 'Aussagen',
        'tab_concepts': 'Konzepte',
        'tab_appendix': 'Anhang',
        'tab_questions': 'Fragen',
        'tab_methodology': 'Methodik',
        'tab_citations': 'Zitate',
        'tab_sources': 'Quellen',
        'card_syntheses': 'Dimensionen',
        'card_syntheses_desc': 'Tiefenanalyse nach Forschungsdimension',
        'card_megatrends': 'Megatrends',
        'card_megatrends_desc': 'Dimensionsübergreifende Kräfte',
        'card_trends': 'Trends',
        'card_trends_desc': 'Evidenzbasierte Muster nach Planungshorizont',
        ...
        'nav_title_synthesis': 'Dimensionen',
        'nav_title_megatrends': 'Megatrends',
        'nav_title_trends': 'Trends',
        'aria_section_nav': 'Abschnittsnavigation',
        'kanban_corner': 'Dimensionen',
        'toc_contents': 'Inhalt',
        ...
        'nav_other': 'Sonstige',
        'js_type_trend': 'Trend',
        'js_type_synthesis': 'Dimensionssynthese',
        'js_type_finding': 'Erkenntnis',
        'js_type_claim': 'Aussage',
        'js_type_source': 'Quelle',
        'js_type_concept': 'Konzept',
        'js_type_megatrend': 'Megatrend',
        'js_type_citation': 'Zitat',
        'js_type_dimension': 'Dimension',
