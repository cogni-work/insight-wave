...
When the user is unsure, default to `standard` — it matches the depth of a typical trend dossier and aligns with how the downstream visualizer (`cogni-trends:trends-dashboard`) lays out the booklet.
