...
When the user is unsure, default to `standard` — it matches the depth of a typical trend dossier and aligns with how downstream visualizers (`cogni-trends:trends-dashboard`) lay out the booklet.
