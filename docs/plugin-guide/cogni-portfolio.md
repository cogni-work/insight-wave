...
| cogni-publishing | portfolio-communicate | Pitch narratives with arc_id, following the `text-to-narrative` arc contracts; `text-to-narrative` builds the design brief from them |
| cogni-publishing | portfolio-dashboard | Theme selection via manage-themes Operation 11 |
